...
TREE_ALGORITHM_PROBLEMS=subordinates tree-matching tree-diameter tree-distances-I tree-distances-II company-queries-I company-queries-II distance-queries counting-paths subtree-queries path-queries distinct-colors finding-a-centroid
