...
RANGE_QUERY_PROBLEMS=static-range-sum-queries static-range-minimum-queries dynamic-range-sum-queries dynamic-range-minimum-queries dynamic-range-minimum-queries-2 range-xor-queries forest-queries
