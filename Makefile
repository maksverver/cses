...
DYNAMIC_PROGRAMMING_PROBLEMS=dice-combinations minimizing-coins coin-combinations-I coin-combinations-II removing-digits grid-paths-DP book-shop array-description counting-towers edit-distance

PROBLEMS=$(INTRODUCTORY_PROBLEMS) $(TREE_ALGORITHM_PROBLEMS) $(SORTING_AND_SEARCHING_PROBLEMS) $(DYNAMIC_PROGRAMMING_PROBLEMS)
