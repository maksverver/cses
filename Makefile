...
MATHEMATICS_PROBLEMS=exponentiation exponentiation-II counting-divisors common-divisors sum-of-divisors divisor-analysis prime-multiples counting-coprime-pairs binomial-coefficients creating-strings-II distributing-apples christmas-party bracket-sequences-I bracket-sequences-II fibonacci-numbers
...
CXXFLAGS=-std=c++20 -Wall -Wextra -Og -g -Wno-sign-compare -D_GLIBCXX_DEBUG
